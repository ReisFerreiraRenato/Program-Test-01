...
/****** Object:  Database [TESTE]    Script Date: 08/11/2021 07:19:35 ******/
CREATE DATABASE [TESTE]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'TESTE', FILENAME = N'D:\BD\TESTE.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'TESTE_log', FILENAME = N'D:\BD\TESTE_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
